...
{
	char cdocs[512+1];
	double *Vars2Print; // 3D
	double *coord1P, *coord2P, *coord3P; // 1D
...
// --
	...
	int kzwidth=1; //, junitmin, junitmax, jcount, jset=300, jskip=4, jloop=0;
	const double gamma = 5.0/3.0;
	const double gm1 = 2.0/3.0; //gamma-1.0;
	double ab1, ab2, ab3, av1, av2, av3, am1, am2, am3, aden, aprs;
	float *coord1, *coord2, *coord3; // 1D
	float *var1, *var2, *var3, *var4, *var5, *var6, *var7, *var8, *var9, *var10;//3D
	char infile[128];
	FILE *fp;
// --
	...
	savedata(var1, ixsize*iysize*kzwidth, "density");
	savedata(var2, ixsize*iysize*kzwidth, "pressure");
	savedata(var3, ixsize*iysize*kzwidth, "velocity1");
	savedata(var4, ixsize*iysize*kzwidth, "velocity2");
	savedata(var5, ixsize*iysize*kzwidth, "velocity3");
	savedata(var6, ixsize*iysize*kzwidth, "magfield1");
	savedata(var7, ixsize*iysize*kzwidth, "magfield2");
	savedata(var8, ixsize*iysize*kzwidth, "magfield3");
	savedata(var9, ixsize*iysize*kzwidth, "enstrophy");
